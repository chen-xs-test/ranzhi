...
from Python.workspace.selenium.ranzhi.base.HTMLTestRunner import HTMLTestRunner
from Python.workspace.selenium.ranzhi.base.util import Email
...
class TestRunner:
    ...
    def runner(self):
        ...
        # 参数1： 用例所在的路径
        # 参数2： 用例过滤条件
        suit.addTests(unittest.TestLoader().discover(r'F:\PythonTest\Python\workspace\selenium\ranzhi\test',pattern='login_test.py'))
