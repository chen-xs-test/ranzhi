...
class Email:
    ...
    @staticmethod
    def send(receivers,subject=None,content=None,path=None,sender='18182437709@163.com',smtpserver='smtp.163.com',port=25,password='AVNCNFWSUJQEALFA'):
        '''
        发送电子邮件
        receivers:  收件人地址
        subject:    主题
...
if __name__ == "__main__":
    ...
    <p>敬礼，Tom</p>
    '''
    path = r'F:\PythonTest\Python\workspace\selenium\ranzhi\report\report_2021-01-11_16-59-09.html'
